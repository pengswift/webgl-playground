var VSHADER_SOURCE =
    ...
    ' int face = int(a_Face);\n' +  // 传入顶点信息时 ，将顶点所在的面的信息也传入
    ' vec3 color = (face == u_PickedFace) ? vec3(1.0) : a_Color.rgb;\n' +  // 被选中的面，顶点设置为红色
    ' if (u_PickedFace == 0) {\n' +                         //  -1, 初始化状态, 0, 选中用作判断的状态，用alpha 做判断 
...
function initVertexBuffers(gl) {
    ...
    if (!initArrayBuffer(gl, colors, 3, gl.FLOAT, 'a_Color')) return -1; // Color 
    if (!initArrayBuffer(gl, faces, 1, gl.UNSIGNED_BYTE, 'a_Face')) return -1; // Face 
